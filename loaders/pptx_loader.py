...
class PptxLoader(base_loader.BaseLoader):

    def __init__(self, file_path:str, chunk_size:int = 300, chunk_overlap:int = 50):
    ...
    def _extract_text(self)->Generator[Document, None, None]:
        loaders = [
            ('UnstructuredLoader', UnstructuredLoader(self.file_path, strategy=PartitionStrategy.HI_RES, mode='elements')),
            ('UnstructuredPowerPointLoader', UnstructuredPowerPointLoader(self.file_path, strategy=PartitionStrategy.HI_RES, mode='elements'))
        ]
    ...
    def load(self)->List[Document]:
        ...
        for i, chunk in enumerate(chunks):
            chunk.metadata.update(
                {
                    'sourceId':str(os.path.basename(self.file_path)),
                    'chunk_index':i,
...
#     filePath = "C:/Users/Dell/Downloads/Project-Proposal (1).pptx"
